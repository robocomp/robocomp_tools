...
## Dependencies
The following dependencies are required to build and run ${component_name}. Ensure they are installed and properly configured on your system before proceeding:
```
<YOUR DEPENDENCIES>
```

## Configuration parameters
Like any other component, ${component_name} requires a configuration file to start. In etc/config or etc/config.toml, you can find an example of the configuration file.
...
bin/${component_name} etc/yourConfig # Execute the component
```
-----
-----
# Developer Notes
This section explains how to work with the generated code of ${component_name}, including what can be modified and how to use key features.
## Editable Files
